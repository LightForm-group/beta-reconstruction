...
##
# Tests for calc_beta_oris
##
def test_calc_beta_oris_return_type(ori_single_valid):
...
def test_calc_beta_oris_calc(ori_single_valid):
    beta_oris = recon.calc_beta_oris(ori_single_valid)
...
##
# Tests for construct_quat_comps
##
...
##
# Tests for beta_oris_from_cub_sym
##
def test_beta_oris_from_cub_sym_return_1_ori_return_type(ori_single_valid):
    cub_sym_idxs = range(0, 9)

    for cub_sym_idx in cub_sym_idxs:
        beta_oris = recon.beta_oris_from_cub_sym(
            ori_single_valid, cub_sym_idx, 0
        )
...
def test_beta_oris_from_cub_sym_return_1_ori_calc(ori_single_valid):
    expected_comps = np.array(
        [0.11460994, 0.97057328, 0.10987647, -0.18105038]
    )
...
def test_beta_oris_from_cub_sym_return_3_ori_return_type(ori_single_valid):
...
def test_beta_oris_from_cub_sym_return_2_ori_return_type(ori_single_valid):
    cub_sym_idxs = range(10, 12)

    for cub_sym_idx in cub_sym_idxs:
        beta_oris = recon.beta_oris_from_cub_sym(
            ori_single_valid, cub_sym_idx, 2
        )
...
def test_beta_oris_from_cub_sym_invalid_cub_sym_idx(ori_single_valid):
...
def test_beta_oris_from_cub_sym_invalid_hex_sym_idx(ori_single_valid):
    with pytest.raises(ValueError):
...
##
# Tests for calc_misori_of_variants
##
